...
#sed -e 's/v1.30.1\([-+]\)/v1.30.2\1/g' -e 's/k3s[0-9]$/k3s1/g' -i k3s-upgrade-1.30.2-k3s1.yaml

#Deleting labels added by system-upgrade script
SERVER_PLAN_NAME=k3s-server-v1.30.1-k3s1
AGENT_PLAN_NAME=k3s-agent-v1.30.1-k3s1
