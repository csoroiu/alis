...
#sed -e 's/v1.29.4\([-+]\)/v1.29.5\1/g' -e 's/k3s[0-9]$/k3s1/g' -i k3s-upgrade-1.29.5-k3s1.yaml

#Deleting labels added by system-upgrade script
SERVER_PLAN_NAME=k3s-server-v1.29.4-k3s1
AGENT_PLAN_NAME=k3s-agent-v1.29.4-k3s1
